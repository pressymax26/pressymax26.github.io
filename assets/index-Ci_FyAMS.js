...
<p>After reading this article, we are sure that delegates still have many questions lingering in their mind about what SUSS has to offer. Hence, we strongly encourage everyone to continue reading up about the young university’s various programmes – not just their undergraduate programmes, but also their graduate programmes. Remember, stay curious!</p>`,articleThumbnail:`/suss-jobs.png`},{id:`yummers`,title:`Motion To Set The Agenda – On Where To Have Committee Dinner`,deck:`By Olivia Yeoh and Lin Yi`,articleThumbnail:`/pplEating.jpeg`,content:`
    ...
    <table style={{width:'100%'}}>
      <thead>
        <tr>
          ...
          <img src="taiwan-ichiban.png"></img></img>
...
<img src="/springleaf.png"></img></img>
...
<img src="/chimi-changa.png"></img></img>
...
<img src="/assortedFoods.png"></img></img>
...
<br/>
While the ASEAN states work together overtime to contain health threats in other nations all
over the region, we often miss out on the medical issues springing up internally, in our own
countries.
<br/>
Migrant workers are excluded from public healthcare systems in multiple ASEAN nations, and
have to overcome many barriers, such as exclusionary legal frameworks, expensive insurance
schemes, and limited support from home countries just to gain basic medical services.
<br/>
They are also, for example, afraid of getting arrested. An example of this is in Malaysia, where
government policies link healthcare institutions to immigration enforcement, mandating
undocumented migrant workers to be reported to authorities.
<br/>
As a result, public healthcare facilities are commonly perceived as likely deportation traps
rather than safe spaces for treatment, discouraging migrant workers from seeking medical
attention even when in serious sickness.
<br/>
Factors such language barriers, and limited medical literacy also further reduce migrant
workers’ willingness and ability to access healthcare services.
<br/>
Another problem is regarding the establishment of minimum healthcare standards. ASEAN
countries heavily rely on migrant labour in high risk sectors.
<br/>
Migrant workers working in such hazardous environments, face the risk of occupational
injuries, infectious diseases, and long-term health risks.
<br/>
Establishing minimum healthcare standards may help to address this existing challenge. This
however poses its own set of challenges.
<br/>
First, conflicting government policies have led to confusing and inconsistent standards for
Migrant workers. In the long run, this leads to unclear and unpredictable healthcare protection
for migrants.
<br/>
Secondly, funding is also a large issue. By providing such a minimum standard, a greater
amount of resources will be diverted towards migrants, potentially negatively impacting citizens.
<br/>
So, the true question here is: how can the ASEAN states effectively govern and allocate
responsibilities for migrant health, especially when each member state possesses a vastly
different fiscal capacity, healthcare system, and migration pattern?
<br/>
Is it simply up to the host countries to bear responsibility for financing and provide healthcare
for migrant workers? Currently, that is the case.
<br/>
Thus, an unequal distribution of responsibilities is created, burdening host countries, catalysing
tension between host and sending countries, which is unfavourable.
In countries like Singapore, healthcare systems are already under pressure from ageing
populations, and domestic welfare demands.
<br/>
These situations are adverse and unwanted, and therefore it is vital that ASEAN member states
come up with ways to distribute responsibilities and beneficially collaborate.
<br/>
Solutions regarding this problem have been presented in the conference this week.
<br/>
The Vietnamese Minister of Health introduced in their B.A.N.H. M.I. framework in this week’s
ASEAN Health Meeting, collaborating with other countries including Brunei. This solution
proposes Bi-lateral and multilateral agreements and policies.
<br/>
This means that the solutions taken are more nuanced, and better adapted for each country. In
essence, the solutions cater to every state’s unique needs and stance.
<br/>
Diseases do not recognise national borders. An outbreak can rapidly impact neighboring states.
It is vital that the protection of migrant healthcare be based on collective responsibility and
regional solidarity.
    `},{id:`manila-bulletin-article2`,articleThumbnail:`/manila-bulletin_EWOpEd_1.png`,title:`An interview with the Minister of Education for The Philippines.`,agency:`Manila Bulletin`,content:`
    <p>An interview with the Minister of Education for The Philippines. By Manila Bulletin ​ June 23, 2026, 12:30pm The Philippines Minister for Education in a picture with other Ministers. PROGRESS MADE IN ASED As ASED moves into the second day of debate, the implications of their English focused solutions are becoming clear. The council has come to a consensus on the vitality of learning the global language for promoting domestic economy as well as global competitiveness, and are working on solutions to help integrate English into their education systems.</p><p>However, ASED has yet to debate on a deeper level the implications of English being included in ASEAN’s education systems. This includes the economic impacts as well as cultural ones – two distinct factors that carry significant weight for a region as economically and culturally diverse as South-East Asia. Despite the lack of discussion, some ministers have provided valuable insights regarding the potential benefits that English in their education system provides to their nation. Most notably, the Philippines, whose economy is substantially buoyed by its overseas workforce, has much to contribute to this debate. The Education Minister of the Philippines replied to our question about the positive aftereffects of integrating English in the Press Conference by saying that “as the world becomes more globalised, Filipinos would interact with people from different countries.” “A lot of migrants work overseas to send money back,” therefore English language education “has to be a crucial part of our education system eventually," she added. This is no small remittance. Overseas Filipino Workers number in the millions, and their remittances have long served as a vital part of the Filipino economy1. English proficiency is usually the defining factor in whether Filipinos can access higher-paying and more competitive jobs worldwide. Moreover, the Minister of Education from Laos echoes a similar sentiment. “As another country with a large population of migrant workers, proficiency in English is imperative in achieving employment within Singapore or Malaysia,” the Minister remarked. WHAT THIS MEANS As a common working language, it would allow more qualified migrant workers to increase their income and work opportunities, as opposed to remaining farmers in their homeland. 1Philippine Statistics Authority. “2023 Overseas Filipino Workers (Final Results).” Philippine Statistics Authority, Philippine Statistics Authority, 13 Sept. 2024, psa.gov.ph/statistics/survey/labor-and-employment/survey-overseas-filipinos. Accessed 23 June 2026.</p><p>However, the Minister from the Philippines emphasized that English fluency went further than just a skill for overseas work, deeming it necessary for the country’s future economic survival even back at home. “Learning English is essential for the next generation of Filipinos to survive in the world so they will be able to effectively communicate with professionals from other countries,” she added. The Minister cited the tourism sector as well as the commercial sector as fields which might demand fluent English speakers. Therefore, it’s unsurprising that such a highly demanded skill would have to be provided by the nation’s government. Additionally, because the council has made it very clear that ASEAN would stick to its principle of non-intervention, the baton is then passed to the governments of each individual country. In the Philippines’s case, there is no small shortage of thorough planning and execution. “When you go into primary school you have your mother tongue as the main medium of instruction with English alongside. Then in secondary school, you slowly progress and transition to having English as the main medium of instruction,” the Minister explained. This “transitional model” had previously been discussed by other delegates as a way of incorporating English language studies into communities dominated mainly by minority groups who speak their non-English mother tongue. Indeed, the council noted the importance of flexibility as countries face different levels of resource readiness, economic interests and linguistic variety. In the Philippines case, the Minister stressed the importance of English as the lingua franca of the new world, saying “Using the national language is important, but I would consider it secondary to using a global language because tagalog is so rarely spoken in foreign nations”. When asked if this might lead to a loss of traditional heritage, she clarified that “[c]ultural preservation is still important. You have to be connected to your roots and your cultural identity. You can’t have it eroded all of a sudden. It’s important to strike a balance”.</p><p>This emphasis on balance reflects the Philippines' stance that though language is a vital medium for economic development, particularly in a globalized world, it is also the medium for a shared national identity. This view is shared by many of her neighbours such as the Ministers of Education for Malaysia, Indonesia and Timor-Leste. Each of these delegates recognised the importance of having both national, traditional and working languages exist side-by-side, not simply coexisting but in fact enhancing the multi-lingual culture many countries cherish. Perhaps specifically in the case of ASEAN, having a common working language, that being English, is not just meant to convenience diplomacy but to actively enhance it. The Filipino Minister points out this feature as “[w]hen you have ASEAN meetings it’s gonna be more effective since there will be less misread nuances”. Subsequently, quite literally “speaking the same language” allows diplomats and citizens alike to break down barriers of ignorance and overcome typical assumptions we might carry about our fellow SEAblings. These actions give a more tangible idea to what Foreign Minister Cayetano meant when he said “[t]he Philippines shall remain an enemy to none and a friend to all in its pursuit of economic and political benefits for the country”2. WHAT THIS SHOWS What this careful balancing act goes to show is that language, being ever evolving, must never be taken for granted. To this end, ASED has taken great care to outline goals for ASEAN, create flexible frameworks for diverse nations and provide foresight on how countries ought to move forward in their education policies, which shows their commitment to respecting nations’ sovereignty as well as their different economic and cultural conditions. 2 Ramos, Marlon. “Cayetano: PH Will Remain an Enemy to None, a Friend to All.” INQUIRER.net, Philippine Daily Inquirer, July 2017, globalnation.inquirer.net/158770/cayetano-ph-will-remain-enemy-none-friend. Accessed 23 June 2026.</p><p>Rather than imposing a singular standard upon a region as linguistically and culturally diverse as South-East Asia, the council has demonstrated an awareness that effective policy must meet them where they are. The tiered transition solution brought up by the Philippines is the best example of this, as they acknowledged that countries with a weaker level of foundational literacy cannot be held to the same standards as countries with a strong level of literacy. As a last note, the Minister also brought up the importance of parents, encouraging them to pass down their mother tongue and encouraging students to still use it at home. It is a good reminder that above government policies and economic concerns, it is to people that language matters most and thus should be treasured at home and across ASEAN.</p>`},{id:`lao-news-agency-article2`,articleThumbnail:`/LaoNews_EWOpED_1.png`,title:`ASEAN Ministers Advance Discussions on Cross-Border Disaster Displacement Framework`,agency:`Lao News Agency`,content:`<p>Title: ASEAN Ministers Advance Discussions on Cross-Border Disaster Displacement Framework Deployment of AHA Centre’s In-Country Liaison Team (ICLT) in the aftermath of Typhoon Yagi, September 2024 ASEAN member states have intensified discussions on strengthening regional cooperation in addressing cross-border disaster displacement (CDD), as Ministers representing the states convened at the ASEAN Committee on Disaster Management (ACDM) meeting to explore and resolve legal, institutional, and operational shortcomings in current frameworks. The session brought to light ASEAN’s increasing awareness of the need for universal legal definitions and more precise policy guidance for the disaster-displaced. Delegates have</p><p>emphasised that there is heightening urgency to establish coordinated response, mainly due to the rising frequency of cataclysms throughout the disaster-prone region.1 Discussions have revealed a common understanding for the need to strengthen existing mechanisms under the ASEAN Agreement on Disaster Management and Emergency Response (AADMER) in order to effectively handle new displacement challenges whilst upholding national sovereignty and the paramount principle of non-interference. Legal Recognition as an Initial Step In order to resolve issues fundamentally, Thailand has highlighted the foremost importance to refine the definitions included in legal frameworks. An example would be the legal definition of “disaster-displaced persons”, and the rights that come with the status. This is, in turn, directly relevant to whether individuals impacted by disasters would qualify for assistance and protection measures. Ambiguity in definitions would only impede the consistent implementation of support mechanisms across member states, potentially leaving vulnerable populations without timely access to aid. To explore further, Indonesia emphasised the need for formal recognition of disaster-displaced persons within regional frameworks. It proposed for a structured status system to be put in place. This system would target all affected individuals, which would help to standardise responses across all ASEAN member states. The delegations have noted the possible destruction of physical documents during disasters. In light of this, Indonesia has called for the digitalisation of IDs to be pushed out in order to facilitate such a framework. 1 ASEAN Secretariat. “Changing Disaster Risk Landscape due to Climate Change in ASEAN.” n.d. https://asean.org/wp-content/uploads/2025/04/20240324_Trend-Report_DM-10-2025.pdf.</p><p>The good news is that, overall, delegations have shown a positive attitude towards the implementation of a mature and effective technology as such. However, solutions to further complications such as financial strains and manpower complexities are yet to be discussed. Institutionalised Solutions Garner Support To improve regional cooperation, the Minister of Laos has proposed for new solutions and for these frameworks to be institutionalised under the current AADMER. The solution, titled ASEAN Cross-border Disaster Displacement Taskforce (ACT), aims at adding on to current measures under AADMER and the ASEAN Coordinating Centre for Humanitarian Assistance on Disaster Management (AHA Centre) while significantly improving regional coordination. Currently, under AADMER, the various national disaster management agencies are supported by a binding agreement. However, the agreement does not touch on regional collaboration in this field or the specifics of handling the victims of CDD. There are no provisions for these agencies to report to and work closely with the AHA centre or other regional organisations nor are there capable bodies tasked to handle CDD, limiting the effectiveness of AADMER and the measures understated.2 With the addition of the ACT, CDD becomes a key focus for member states, mandating and supporting targeted approaches towards helping those displaced or affected. Commenting on the solutions of fellow ASEAN counterparts, the Minister of Laos also welcomed the myriad of ideas proposed which allow for higher flexibility and broaden the range of scenarios the region is prepared to tackle. The Minister also reaffirmed current measures and frameworks rolled out by ASEAN and called for member states to weave the varied solutions in discussion into current existing structures. 2 S. Nanthini. “IP25094 | ASEAN as ‘Global Leader’ in Disaster Management: A Problem of Finance?” 2017. RSIS_NTU. 2017. https://rsis.edu.sg/rsis-publication/idss/ip25094-asean-as-global-leader-in-disaster-management-a-problem-of-financ e/.</p><p>Persistent Emphasis on the Sovereignty of Nations Although regional collaboration is crucial to addressing CDD, the sovereignty of member states should also not be overstepped in the process, says the Minister of Laos. The protection of sovereignty has remained an important principle in Laos’ foreign policy, and is a shared sentiment within ASEAN. However, with most delegates, including foreign dialogue partners, proposing solutions to call for close partnerships and strong binding, member states have raised worries about the risk of foreign intervention. In response to concerns on national sovereignty, the ACT framework was amended by the Minister of the Philippines to include clauses that allow member states to prioritise internal displacement and nation-based solutions for natural disasters of smaller scale or within capacity. Alongside proposals for institutional strengthening, delegates also underscored the importance of balancing regional cooperation with respect for national sovereignty and the principle of non-interference, which remains a key pillar of ASEAN’s framework. The Minister of Laos reiterated that any regional mechanism addressing cross-border disaster displacement must first fully respect national sovereignty while guaranteeing affected populations with timely and appropriate support. Coordination mechanisms should remain adaptable, allowing for member states to adopt measures in line with their respective national contexts and capabilities. In order to support impacted nations while maintaining national sovereignty, the Cambodian delegation also voiced support for the establishment of a voluntary disaster displacement funding structure. In parallel, discussions also touched upon the concept of temporary visa arrangements within ASEAN to facilitate the movement and protection of disaster-displaced persons. Although some delegates viewed the proposals as a progressive step towards improving humanitarian response,</p><p>it was also acknowledged that further study would be required to assess its legal and administrative implications across different national systems. Expanding Capital Horizons Beyond ASEAN In addition to legal and protection measures, the Ministers have also placed strong emphasis on the issue of funding and the mobilisation of resources, particularly in participating countries with limited capacity to respond to large-scale disaster displacement. The Minister of Laos noted that relatively less developed countries within ASEAN face structural and financial constraints in terms of disaster-response. Therefore, Laos proposed a more centralised funding system, with China, Brunei, and Australia already expressing willingness to provide aid. The structure consists of contributions possibly focusing on more economically developed participants. This ensures equitable access to resources across the region. However, the eligibility criteria and conditions involved have not been deliberated. Momentum Gained and More to Come Indeed, significant progress has been made towards tackling the issue of CDD and reaching commendable consensus on the need for stronger regional coordination. Recognition and documentation of CDD related data, along with funding required for the improvement of current frameworks and institutionalised collaboration remain utmost priorities for the region. Differing perspectives especially regarding sovereignty concerns have and will continue to surface, but ASEAN has proved its willingness to resolve the issue and produce pragmatic and ASEAN-centred solutions in these past sessions of active discussion.</p>`},{id:`sbs-news-article1`,articleThumbnail:`/SBSNews_EWOpEd_1.png`,title:`Countries discuss standing united against irregular migration in ASEAN`,agency:`SBS News`,content:`<p>Expanded Word Count Article Name of Delegate: Tan Zhi’En Janessa, Loke Ting Rui Agency: SBS News Assigned Council: DGICM Countries discuss standing united against irregular migration in ASEAN Various countries brought individual solutions together during a recent conference Image source: The Atlantic Council Irregular migration is a serious and very real issue arising. Many global attempts have been made to fix this issue, but each country has its own views. Irregular migration is getting worse</p><p>Irregular, also known as “unauthorised” and “undocumented”, is often mistaken for a specific type of migrant. However, it actually describes a migrant's legal status. This very status can change at any point in their journey.1 For example, migrants fleeing conflict may be counted as irregular when crossing the border but become regular when applying for asylum. Furthermore, migrants who enter regularly may become irregular when their visa or residence permit expires. Irregular migration as a whole is the movement of people outside a country's legal framework. The dangers that one may experience are endless, including treacherous routes, violence from others, etc. 2 Refugees from countries like Myanmar (particularly Rohingya people) often lack travel and identity documents. They face a lack of prospects for stability, safety and economic and educational opportunities in their countries of origin or in countries of first displacement (e.g., Bangladesh). 2 Iom.int. “Irregular Migration and Identity: More than Just Documents | ONU Migración Americas,” 2018. https://lac.iom.int/en/blogs/irregular-migration-and-identity-more-just-documents. 1 Migration Data Portal. “Irregular Migration,” 2022. https://www.migrationdataportal.org/handbooks/chapter-4-introduction-key-concepts-and-definit ions/irregular-migration.</p><p>Climate-related factors also exacerbate the situation, forcing these people to become undocumented migrants. Even if the immigrants make it to their destination safely, the same cannot be said about what awaits them. As unknown members of the state, they do not have access to necessary services like healthcare. Why is it “bad”? Firstly, every country has their own system of laws, and every law exists for a reason. By staying in a country illegally, immigrants directly violate the country’s immigration laws and disrespect the system of government. Their disrespect for the system is a clear indication that they may not abide by the laws that currently exist in their country. When the Rule of Law is degraded, chaos can ensue.3 Furthermore, the impact of irregular migration on the country’s economy is significant. This includes the cost of illegal immigration to the taxpayer. However, the highest costs are the education of their children, emergency medical care, etc. Moreover, irregular migration also contributes largely to population growth, which overwhelms countries by consuming already limited resources. These may include affordable housing, crowded classrooms, and public services. This affects countries that are deemed “more attractive” due to their wealth on a larger scale. Unrestricted population growth also harms the environment by increasing the already existing strain on vital natural resources. 3 Federation for American Immigration Reform. “What’s Wrong with Illegal Immigration? | Federation for American Immigration Reform.” Fairus.org. Federation foassaultr American Immigration Reform, 2019. https://www.fairus.org/issue/illegal-immigration/whats-wrong-illegal-immigration.</p><p>Lastly, irregular immigrants have also threatened citizens’ safety and well-being. As irregular immigration increases, so has the trafficking of drugs such as fentanyl. When irregular immigrants illegally join communities without proper vetting, the citizens increasingly become victims of crime, including hit-and-runs, assault, and even murder. In addition, they often steal others’ identities to live, work and remain in the country. The take on irregular migration During the discussion, countries have raised their concerns and interests regarding the issue. Australia has taken a firm stance on irregular migration. With Australia prioritising social cohesion, human rights, and migration policies, they show zero tolerance towards this issue. “Australia will fund any form of initiative that discourages smuggling, with state sovereignty of ASEAN states to be prioritised” Australia is focusing on supporting all countries by joining blocs and helping to improve current proposed solutions, as well as generating more ideas to enhance border security measures globally. Thailand serves as a major origin, transit and destination country for illegal immigration. They consider people who enter the country without authorisation to violate immigration laws and generally support arrest, detention, deportation and fines ranging from 5000 to 200000 baht. Since they have a high demand for low-wage migrant workers, Thailand aims to improve its labour system and immigration policies by coordinating with neighbouring countries. Countries such as the United States are also open to funding future frameworks and operations to ensure countries can curb the issue.</p><p>Proposed solutions Currently, the Strategic Hub for Intelligence Exchange and Law Enforcement Disruption (SHIELD) framework has been proposed, with countries discussing its feasibility and whether to support it. The SHIELD framework is a large umbrella of solutions which touches on multiple aspects of border management. Firstly, Surveillance Cooperation is a regional smuggling watch system where participating states report high-risk maritime and land corridors and contribute maritime flow data. States would also retain full authority over operation, and can use information provided by other states to better facilitate their own operations Secondly, harmonised intelligence exchange encourages communication protocols between immigration, border security and law enforcement agencies across participating states. Thirdly, Investigative cooperation, which is a service that participating countries can request, provides investigative assistance in cross-border smuggling cases, coordinates evidence collection, conducts joint operations and traces financial flows. All of these activities are said to be between consensual member states. Additionally, enforcement capacity building provides annual training academies for immigration and border officials, document fraud, maritime interaction and financial crime analysis, as well as anti-corruption and integrity-building workshops.</p><p>Lastly, liaison networking to expand Booth Level Officers (BLO) to coastal borders and build on existing solutions by the UNODC. Concerns While the large framework seems effective against illegal immigration on the surface, countries are concerned with the size of the framework. “The proposed solutions are too broad and not specific enough for every country.” And “No solution is a one-size-fits-all” was raised by Singapore, Myanmar and the Philippines. The Minister of South Korea has also shown their dissatisfaction with the loopholes in the framework, causing South Korea to pull out of supporting SHIELD. Other concerns include how the framework should improve on existing frameworks, as certain solutions have overlapped with current ASEAN policies. Additionally, ASEAN countries are especially worried about the extent of interference of solutions with sovereign states and their decision-making and processes. SHIELD represents a significant step towards coordinated efforts between countries. However, while the framework emphasises cooperation and intelligence sharing, it remains unclear how participating states can ensure that external influence does not gradually shape domestic border policies. Migration management is deeply intertwined with national security, and governments must retain the ability to independently determine who enters their territory, how immigration laws are enforced, and what level of information is shared with foreign partners. With more considerations, it is believed that SHIELD would then be able to fully demonstrate how regional cooperation can enhance border security while preserving humanitarian responsibility. What would the final solution look like?</p><p>Reaching a common consensus is important for countries to improve international communication and relationships. While the framework has not been finalised, countries continue to discuss and build on these proposed solutions.</p>`},{id:`the-star-article1`,title:`Dedollarisation and Digital Currencies: ASEAN’s Stance and Solutions`,agency:`The Star`,content:`What once dominated the Association of Southeast Asian Nations’ (ASEAN’s) global
...
`},{id:`antaraNews-article2`,articleThumbnail:`/antaraNews_OpEd1_1.png`,title:`Indonesia to partake in information-sharing network with various countries`,agency:`Antara News`,content:`
    <img src="/antaraNews_OpEd1_1.png"></img></img>
...
`},{id:`the-star-article2`,title:`Going for Gold: Malaysia unveils stance and potential contributions at AGMFM Negotiations`,agency:`The Star`,content:`
...
billion derived from investments. Fulcrum reported that it is channeled toward “employment,
...
Photograph: Olivia Harris/Reuters</strong></p>
    ...
    <p>Today, governments gather together at the ASEAN Directors-General of Immigration
Departments and Heads of Consular Affairs Divisions of the Ministries of Foreign Affairs
Meeting (DGICM) to discuss, coordinate and enhance border control systems in an urgent effort
to combat transnational irregular migration.</p>

<p>The Minister of Bangladesh proposed a framework with the intentions of minimising irregular
migration, SHIELD, which stood for Surveillance, Harmonise intelligence exchange,
Investigative cooperation, Enforcement of capacity building training and Liaison Offices.</p>

<p>The committee is deadlocked in a fierce debate over the effectiveness of the SHIELD
framework. Immigration hardliners are stalling the process, with Ministers of Singapore and
Philippines demanding isolation through the need for an “ASEAN- exclusive department”. As a
reply, the Minister of Bangladesh reiterated that “ASEAN cannot afford to be a close cocoon"
and emphasised the need to remain open for global collaboration and support.</p>

<p>The dispute escalated with other countries taking sides. With two prominent blocs emerging, the
supporting bloc led by Bangladesh, Timor-Leste and GCC, and the opposing bloc led by
Singapore and Philippines.</p>

<p>As the major blocs bickered over minor technicalities, millions of desperate asylum seekers were
left stranded, displaced and vulnerable. In the waters that ASEAN member states border and
patrol, a Rohingya refugee was dying or disappearing every ten hours in 2025. One in seven who
attempted the crossing never arrived, and over half of them were women and children.</p>

<p>Meanwhile, other ASEAN countries in desperate need for funding are unable to receive the help
required, preventing them from taking immediate and timely action to curb the issue.</p>

<p>“Time waits for no man.” The Minister of Cambodia as he urged the council to come to an
agreement citing the lack of progress. As such, the Minister of Vietnam requested that the
Minister of Singapore propose amendments to the SHIELD framework, with Singapore yet to do
so.</p>
<p>Given Singapore’s technologically advanced background and wealth in ASEAN, Singapore has a
refined security system which utilizes AI, surveillance footage and specialised technology like Radiographic Scanning Portal. Singapore’s willingness to compromise would contribute
significantly to the progress of the council.</p>

<p>The council has to face this question once and for all. Is ASEAN truly in the position to prioritise
politics over human lives?
</p>
<p>
Behind every framework are human lives, exploited workers, and families fleeing disaster. While
ASEAN has the resources, the mandate, and the moral obligation to act, we are running out of
time. If the committee continues its circular debate and misplaces its focus on framework
specifics, by the time an ideal proposal is approved, the damage would be irreversible.
</p>

<p>
ASEAN cannot solve a transnational crisis with a parochial mindset. In order for ASEAN to
progress, it must be open to regional and global collaboration. This includes maintaining trust,
making compromises, and cooperating to ensure that implemented systems can run smoothly.
</p>
<p>
The sooner countries can agree on a policy, the sooner migrants can find a home and the sooner
peace will be restored in the region.</p>
`},{id:`associated-press-article1`,title:`U.S. Deportation and the Limits of DGICM`,agency:`Associated Press`,articleThumbnail:`/AP_OpEd1_1.png`,content:`<p>Countries in the ASEAN Directors-General of Immigration and Heads and Consular Affairs (DGICM) are currently tackling the challenge of irregular immigration. ASEAN holds a high demographic of irregular migrants, which poses a prevalent issue.</p>
...
<p>Deportations need to be ensured as necessary and also responsibly carried out. DGICM is urged to address this in the implementation of their Irregular Migration policies with U.S. cooperation. Where immigrant rights are being emphasised in this committee, members will continue to discuss and come to a consensus.</p>`},{id:`khmer-times-article1`,title:`Solutions proposed during the ASEAN Ministerial Meeting on Transnational Crime against Light Arms Trafficking`,agency:`Khmer Times`,agencyLogo:`Khmer_Times.png`,content:`
...
refined through future council sessions.
        `},{id:`tass-article1`,title:`ASEAN members and how`,agency:`Russian News Agency TASS`,agencyLogo:`TASS.png`,content:`For the majority of ASEAN’s sustainability status, ASEAN member states have been
